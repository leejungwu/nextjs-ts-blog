...
const Home = () => {  // ssr로 mainPosts 유지되게 해야됨. [id]로 들어오기전에 mainPosts 확인해서 오류
    ...
    const onUnlike = useCallback(() => {  // 로그인 안한 사람이 좋아요 어떻게?
        dispatch({
    ...
    return (
        <>
            <Head>
                ...
                {/* <meta property="og:image" content={'https://jdouble.me/favicon.ico'} />
                <meta property="og:url" content={`https://jdouble.me/post/${id}`} /> */}
            </Head>
            <Layout>
